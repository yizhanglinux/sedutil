...
DtaDevWindowsNvme * DtaDevWindowsNvme::getDtaDevWindowsNvme(const char * devref,
  ...
  OSDEVICEHANDLE fd_=openAndCheckDeviceHandle(devref, accessDenied);
  if (fd_==INVALID_HANDLE_VALUE || accessDenied) {
  ...
  DtaDevWindowsNvme * drive = new DtaDevWindowsNvme(fd_);
