...
uint8_t DtaOptions(int argc, char * argv[], DTA_OPTIONS * opts)
{
	...
	for (uint8_t i = 1; i < argc; i++) {
		...
		BEGIN_OPTION(eraseLockingRange_SUM, 3)
			...
			TESTARG(17, lockingrange, 17)
			TESTARG(18, lockingrange, 18)
			TESTARG(19, lockingrange, 19)
			TESTARG(20, lockingrange, 20)
			TESTARG(21, lockingrange, 21)
			TESTARG(22, lockingrange, 22)
			TESTARG(23, lockingrange, 23)
			TESTARG(24, lockingrange, 24)
			TESTARG(25, lockingrange, 25)
			TESTARG(26, lockingrange, 26)
			TESTARG(27, lockingrange, 27)
			TESTARG(28, lockingrange, 28)
			TESTARG(29, lockingrange, 29)
			TESTARG(30, lockingrange, 30)
			TESTARG(31, lockingrange, 31)
			TESTFAIL("Invalid Locking Range (1-31)")
			OPTION_IS(password) OPTION_IS(device) END_OPTION
		...
		BEGIN_OPTION(eraseLockingRange, 3)
			...
			TESTARG(30, lockingrange, 30)
			TESTARG(31, lockingrange, 31)
			TESTFAIL("Invalid Locking Range (0-31)")
			OPTION_IS(password)
			OPTION_IS(device)
			END_OPTION
